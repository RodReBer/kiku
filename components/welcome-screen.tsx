      ...
      <div className="md:hidden absolute inset-0 z-10 overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          <img
            ...
            className="mobile-composition block w-full h-full object-contain pt-[1.2vh] pointer-events-none select-none max-[380px]:scale-[1.229] max-[350px]:scale-[1.08] max-[330px]:scale-[1.11] origin-center"
            draggable={false}
            aria-hidden="true"
          />
        </div>
