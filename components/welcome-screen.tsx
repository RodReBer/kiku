...
export default function WelcomeScreen({ onEnterDesktop }: WelcomeScreenProps) {
      ...
      <div className="flex flex-row items-end gap-7">
        {["/inicio/KK.svg", "/inicio/I.svg", "/inicio/KK.svg", "/inicio/U.svg"].map((src, idx) => (
          <img
            ...
            alt=""
            draggable={false}
            className="h-[90vh] 2xl:h-[100vh] max-h-screen w-auto"
          />
        ))}
      </div>
      {/* CREAM */}
  ...
  <div className="absolute top-[10%] left-1/2 md:left-[52%] xl:left-[55%] 2xl:left-[57%] 2xl:top-[5%] -translate-x-1/2 z-[2000] hidden md:flex flex-row items-center justify-center pointer-events-auto">
          <motion.img
  ...
  <div className="absolute left-1/2 top-[70%] max-[420px]:top-[71%] max-[380px]:top-[74%] max-[340px]:top-[76%] -translate-x-1/2 ">
          <motion.img
            src="/inicio/AQUI.svg"
            alt="Aquí"
